...
class FormationInscription(SQLModel, table=True):
    ...
    participant_nom: Optional[str] = Field(default=None, max_length=100)
    participant_prenoms: Optional[str] = Field(default=None, max_length=150)
    participant_email: str = Field(max_length=255)
    participant_phone: Optional[str] = Field(default=None, max_length=30)
